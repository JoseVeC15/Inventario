    ...
    modal.innerHTML = `
        <div class="swal2-popup swal2-modal swal2-icon-info swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: grid;">
            ...
            <div class="swal2-html-container" id="swal2-html-container" style="display: block;">
                <p class="contact-message">El acceso al panel administrativo está restringido. Contacta con el administrador del sistema para solicitar permisos de acceso.</p>
            </div>
