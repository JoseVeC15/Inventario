...
class Sale:
    ...
    def get_all(limit=None):
        ...
        query = """
            ...
            FROM JoseVeC.ventas v
            INNER JOIN JoseVeC.clientes c ON v.cliente_id = c.id
            INNER JOIN JoseVeC.usuarios u ON v.usuario_id = u.id
    ...
    def count():
        ...
        query = "SELECT COUNT(*) as total FROM JoseVeC.ventas"
    ...
    def create(data, details):
        ...
        query_detalle = """
            INSERT INTO JoseVeC.detalle_ventas 
    ...
    def update(sale_id, data, details):
        ...
        query_delete = "DELETE FROM JoseVeC.detalle_ventas WHERE venta_id = %s"
    ...
    def delete(sale_id):
        ...
        # Eliminar detalles
        query_detalle = "DELETE FROM JoseVeC.detalle_ventas WHERE venta_id = %s"
        Database.execute_query(query_detalle, (sale_id,), fetch=False)
        
        # Eliminar venta
        query_venta = "DELETE FROM JoseVeC.ventas WHERE id = %s"
