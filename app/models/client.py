...
class Client:
    ...
    def count():
        ...
        query = "SELECT COUNT(*) as total FROM JoseVeC.clientes WHERE activo = 1"
    ...
    def delete(client_id):
        ...
        query = "UPDATE JoseVeC.clientes SET activo = 0 WHERE id = %s"
