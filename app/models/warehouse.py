...
class Warehouse:
    ...
    def count():
        ...
        query = "SELECT COUNT(*) as total FROM JoseVeC.almacenes WHERE activo = 1"
    ...
    def delete(warehouse_id):
        ...
        query = "UPDATE JoseVeC.almacenes SET activo = 0 WHERE id = %s"
