...
class Category:
    ...
    def count():
        ...
        query = "SELECT COUNT(*) as total FROM JoseVeC.categorias WHERE activo = 1"
    ...
    def create(data):
        ...
        query = """
            INSERT INTO JoseVeC.categorias (nombre, descripcion, activo)
            VALUES (%s, %s, %s)
        """
        params = (
            data['nombre'],
    ...
    def delete(category_id):
        ...
        query = "UPDATE JoseVeC.categorias SET activo = 0 WHERE id = %s"
