...
class Role:
    ...
    def count():
        ...
        query = "SELECT COUNT(*) as total FROM JoseVeC.roles"
    ...
    def create(data):
        """Crea un nuevo rol"""
        query = """
            INSERT INTO JoseVeC.roles (nombre, descripcion)
            VALUES (%s, %s)
        """
        params = (
            data['nombre'],
    ...
    def delete(role_id):
        ...
        query = "DELETE FROM JoseVeC.roles WHERE id = %s"
